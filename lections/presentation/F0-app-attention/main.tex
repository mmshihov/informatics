...
\begin{frame}
    ...
    \begin{itemize}
        \item Не причинять физический вред человеку, внимания которого нужно добиться. Для краткости: \alert{безвредно} \mode<article>{(Ведь нужно внимание, а не труп. Труп обычно совершенно невнимателен.)}
